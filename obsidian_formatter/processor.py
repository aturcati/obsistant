...
def merge_frontmatter(
    orig: Optional[Dict], tags: Set[str], file_path: Optional[Path] = None
) -> Dict:
...
def process_file(
    path: Path, dry_run: bool, backup_ext: str, logger, format_md: bool = False
):
...
def process_vault(
    root: str, dry_run: bool, backup_ext: str, logger, format_md: bool = False
):
